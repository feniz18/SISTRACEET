    ...
    <form role="form" id="formUpdate" enctype="multipart/form-data">
      ...
      <div class="modal-content" style="display:block;" id='modalContenido'>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 form-group" >
              ...
              <input name="cedulaOld" type="password" class="form-control" placeholder="Contraseña" id='contrasenaOld'>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 form-group">
              <label>Contraseña nueva</label>
              <input name="cedulaOld" type="password" class="form-control" placeholder="Contraseña" id='contrasena'>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 form-group">
        ...
        <div class="modal-footer">
          <button type="button" id="enviar" class="btn btn-outline">Guardar Contraseña</button>
        </div>
      </form>
    </div>
    <!-- /.modal-content -->
